...
<template>
  <svg v-if="name === 'cart'" aria-hidden="true" data-prefix="fas" data-icon="shopping-cart"
    class="svg-inline--fa fa-shopping-cart fa-w-18" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
    <path
  ...
  <svg v-else-if="name === 'angle-right'" aria-hidden="true" data-prefix="fas" data-icon="angle-right"
    class="svg-inline--fa fa-angle-right fa-w-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512">
    <path
  ...
  <svg v-else-if="name === 'angle-down'" aria-hidden="true" data-prefix="fas" data-icon="angle-down"
    class="svg-inline--fa fa-angle-down fa-w-10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
    <path
  ...
  <svg v-else-if="name === 'angle-left'" aria-hidden="true" data-prefix="fas" data-icon="angle-left"
    class="svg-inline--fa fa-angle-left fa-w-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512">
    <path
...
<svg v-else-if="name === 'search'" aria-hidden="true" data-prefix="fas" data-icon="search"
  class="svg-inline--fa fa-search fa-w-16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
  <path
